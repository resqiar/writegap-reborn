	...
	<div class="card bg-base-100 lg:w-[38%] lg:shadow-xl">
		<div class="card-body">
			...
			<p class="text-justify text-sm font-medium">
				We provide a seamless login process with your favorite providers that automatically
				registers new users, i.e <strong>no password stored!</strong> <span>🥳🎉</span>
			</p>

			<!-- PROVIDER LOGIN -->
			<div class="my-6">
				<a
					href={`${PUBLIC_SERVER_URL}/auth/google`}
					class="border-sm btn-ghost btn flex w-full items-center gap-2 border-black"
				>
					<!-- GOOGLE LOGO SVG -->
