...
<main class="mb-32 px-4 py-8 lg:px-24">
	...
	<section class="flex flex-col gap-8 lg:flex-row">
		...
		<div class="lg:w-[20%]">
			<div class="flex w-full flex-col items-center justify-center rounded-lg bg-base-300 py-4">
				...
				<div class="my-4 flex w-full flex-col gap-2 px-4">
					<button class="btn-sm btn w-full gap-2 rounded-full text-sm font-normal normal-case">
